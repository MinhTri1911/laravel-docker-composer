        ...
        <div class="main-summary">
            ...
            <div class="row">
                <div class="col-md-6 block-input">
                    ...
                    <div class="form-input">
                        {{ Form::text('txt-company-name-jp', 'CTY A', [
                                'class' => 'form-control',
                                'tabindex' => 1,
                                'require' => true,
                ...
                <div class="col-md-6 block-input">
                    ...
                    <div class="form-input">
                        {{ Form::text('txt-company-name-en', 'CTY A', [
                                'class' => 'form-control',
                                'tabindex' => 2,
                                'require' => true,
                ...
                <div class="col-md-6 block-input">
                    ...
                    <div class="form-input custom-select">
                        {{ Form::select('slb-company-month-billing[]', [
                                ...
                                'class' => 'form-control custome-select2',
                                'tabindex' => 12,
                                'multiple' => 'multiple',
            ...
            <div class="row">
                <div class="col-md-12 block-button">
                    {{ Form::button(trans('company.btn_update_company'), ['class' => 'btn btn-green-dark btn-w150', 'tabindex' => 40]) }}

    ...
    @if(count($datas) > 0)
        @if(!request()->has('setting_status') || 
            ...
            <div class="block-handle align-right">
                <div class="btn btn-red btn-w150 btn-reject" data-type="1">{{__('approve.btn_reject')}}</div>
                <div class="btn btn-blue-dark btn-w150 btn-approve" data-type="1">{{__('approve.btn_approve')}}</div>
            </div>
        @endif
    @endif
